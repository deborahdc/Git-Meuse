...
hand_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Grouped_layers\grouped_hand1.tif"

output_raster_directory = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Suitability_Deltares"
...
def check_suitability(slope_data, aquifer_data, soil_data, landuse_data, natura2000_data, hand_data):
    suitability = (
        (np.isin(slope_data, [1])) &  # Suitable slope classes
        (np.isin(aquifer_data, [1,2,3,4,6])) &  # Suitable aquifer types
        (np.isin(soil_data, [1, 2, 3, 4, 5, 8])) &  # Suitable soil types
        (np.isin(landuse_data, [2, 3, 4, 5])) &  # Suitable land use
...
output_raster_fp = os.path.join(output_raster_directory, "suitability_floodplain.tif")
...
aquifer_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Grouped_layers\grouped_aquifer.tif"
soil_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Grouped_layers\grouped_soil_texture2.tif"
landuse_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\LandCover_11classes.tif"
natura2000_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Grouped_layers\natura2000.tif"
hand_raster_fp = r"C:\Users\ddo001\Documents\LoFloMeuse\GIS\Data\Saved\NBS\Grouped_layers\grouped_hand1.tif"
...
def check_suitability(slope_data, aquifer_data, soil_data, landuse_data, natura2000_data, hand_data):
    suitability = (
        (np.isin(slope_data, [1])) &  # Suitable slope classes
        (np.isin(aquifer_data, [1,2,3,4,5,6,7])) &  # Suitable aquifer types
        (np.isin(soil_data, [2, 3, 4, 5,8])) &  # Suitable soil types
        (np.isin(landuse_data, [7]))  # Suitable land use
        # (natura2000_data == 0) &  # Exclude Natura 2000 areas
        # (hand_data == 1)  # Consider only areas with HAND value 1
    )
    return suitability
...
# Step 4: Save the suitability result as a raster
output_raster_fp = os.path.join(output_raster_directory, "11suitability_coni_to_peat.tif")
